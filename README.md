...
## 📚 Documentation
- [User Guide](docs/USER_GUIDE.md): End-to-end service flow and business value.
- [Architecture & Tech Specs](specs/architecture.md): Detailed system design.
- [Engineering Standards](specs/engineering.md): Backend and testing guidelines.
- [AI Protocol](specs/ai-protocol.md): AI Agent interaction rules.
- [Project Completion Report](docs/COMPLETED.md): Phase 1~6 roadmap execution log.
- [Prisma 7 Decision Record](docs/PRISMA_DECISION.md): Architectural decisions and tech debt analysis.
